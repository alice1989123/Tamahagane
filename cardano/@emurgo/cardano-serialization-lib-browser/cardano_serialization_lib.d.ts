...
*/
  add_mint_asset_and_output(policy_script: NativeScript, asset_name: AssetName, amount: Int, address: Address, output_coin: BigNum): void;
/**
* Add a mint entry together with an output to this builder
...
* @param {Address} address
*/
  add_mint_asset_and_output_min_required_coin(policy_script: NativeScript, asset_name: AssetName, amount: Int, address: Address): void;
/**
