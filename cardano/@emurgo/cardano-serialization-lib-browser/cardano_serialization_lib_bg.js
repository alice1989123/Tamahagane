...
export class TransactionBuilder {
    ...
    */
    set_mint_scripts(mint_scripts) {
        ...
        wasm.transactionbuilder_set_mint_scripts(this.ptr, mint_scripts.ptr);
    }
    /**
    ...
    */
    add_mint_asset_and_output(policy_script, asset_name, amount, address, output_coin) {
        ...
        wasm.transactionbuilder_add_mint_asset_and_output(this.ptr, policy_script.ptr, asset_name.ptr, ptr0, address.ptr, output_coin.ptr);
    }
    /**
    * Add a mint entry together with an output to this builder
    ...
    */
    add_mint_asset_and_output_min_required_coin(policy_script, asset_name, amount, address) {
        ...
        amount.ptr = 0;
        _assertClass(address, Address);
        wasm.transactionbuilder_add_mint_asset_and_output_min_required_coin(this.ptr, policy_script.ptr, asset_name.ptr, ptr0, address.ptr);
    }
    /**
